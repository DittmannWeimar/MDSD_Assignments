...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int LET__LET = PRIMARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LET__IN = PRIMARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int LET_FEATURE_COUNT = PRIMARY_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.Let#getLet <em>Let</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Let</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Let#getLet()
   * @see #getLet()
   * @generated
   */
  EReference getLet_Let();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference LET__LET = eINSTANCE.getLet_Let();
