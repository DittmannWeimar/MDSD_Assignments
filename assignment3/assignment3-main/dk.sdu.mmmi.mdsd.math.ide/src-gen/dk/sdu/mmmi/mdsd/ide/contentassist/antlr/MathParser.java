...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalAccess().getGroup_2(), "rule__External__Group_2__0");
			builder.put(grammarAccess.getExternalAccess().getGroup_2_1(), "rule__External__Group_2_1__0");
			...
			builder.put(grammarAccess.getProgramAccess().getExternalAssignment_2_1(), "rule__Program__ExternalAssignment_2_1");
			builder.put(grammarAccess.getProgramAccess().getMathAssignment_3(), "rule__Program__MathAssignment_3");
			builder.put(grammarAccess.getExternalAccess().getNameAssignment_0(), "rule__External__NameAssignment_0");
			builder.put(grammarAccess.getExternalAccess().getTypeAssignment_2_0(), "rule__External__TypeAssignment_2_0");
			builder.put(grammarAccess.getExternalAccess().getTypeAssignment_2_1_1(), "rule__External__TypeAssignment_2_1_1");
			builder.put(grammarAccess.getExternalCallAccess().getExternalAssignment_0(), "rule__ExternalCall__ExternalAssignment_0");
			builder.put(grammarAccess.getExternalCallAccess().getParmsAssignment_2_0(), "rule__ExternalCall__ParmsAssignment_2_0");
			builder.put(grammarAccess.getExternalCallAccess().getParmsAssignment_2_1_1(), "rule__ExternalCall__ParmsAssignment_2_1_1");
