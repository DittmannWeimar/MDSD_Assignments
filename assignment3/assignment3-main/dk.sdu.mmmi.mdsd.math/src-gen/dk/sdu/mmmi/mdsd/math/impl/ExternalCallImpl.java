 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.ExternalCallImpl#getParms <em>Parms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalCallImpl extends ExpressionImpl implements ExternalCall
{
   ...
   * @ordered
   */
  protected EList<Expression> parms;
   ...
   */
  @Override
  public EList<Expression> getParms()
  {
    if (parms == null)
    {
      parms = new EObjectContainmentEList<Expression>(Expression.class, this, MathPackage.EXTERNAL_CALL__PARMS);
    }
    return parms;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.EXTERNAL_CALL__PARMS:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MathPackage.EXTERNAL_CALL__PARMS:
        getParms().clear();
        getParms().addAll((Collection<? extends Expression>)newValue);
        return;
    }
